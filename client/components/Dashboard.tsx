...
const Dashboard: React.FC = () => {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      changeType:
        (stats.changes?.clickRate || 0) >= 0 ? "positive" : "negative",
    ...
    },
    {
      ...
      changeType:
        (stats.changes?.campaigns || 0) >= 0 ? "positive" : "negative",
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <select
          ...
          className="px-3 py-2 md:px-4 md:py-2 text-sm md:text-base border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex-1">
                ...
                <p className="text-xl sm:text-2xl font-bold font-display text-gray-900 dark:text-white mt-1">
                  {stat.value}
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6"
        >
          <h3 className="text-base md:text-lg font-semibold font-display text-gray-900 dark:text-white mb-4 md:mb-6">
            Email Performance
          </h3>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 rounded-2xl p-4 sm:p-6"
      >
