...
const Register: React.FC<RegisterProps> = ({ onSwitchToLogin }) => {
  ...
  const handleResendVerification = async () => {
    setIsResending(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://chatriox.com/api'}/auth/resend-verification`, {
        method: 'POST',
        headers: {
          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full  duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
  ...
  return (
    ...
    <a href="/" className="flex items-center gap-2">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Join Chatriox today</p>
        </div>
