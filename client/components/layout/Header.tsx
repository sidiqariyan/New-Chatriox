  ...
  return (
    <header className="sticky top-0 z-50 bg-white text-slate-900 border-b border-black/10">
      <div className="container flex h-16 items-center justify-between">
        ...
        <NavigationMenu.Root className="hidden md:block" onMouseLeave={() => setOpen(null)}>
                ...
                <NavigationMenu.Content forceMount>
                  <div
                    className={cn(
                      ...
                      open === m.label ? "animate-in fade-in-0 zoom-in-95" : "hidden",
                    )}
                    onMouseEnter={() => setOpen(m.label)}
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className="h-9 w-9 rounded-lg bg-sky-500 group-hover:bg-sky-600 transition" />
                                <div>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Button asChild className="bg-sky-500 hover:bg-sky-700 text-white">
