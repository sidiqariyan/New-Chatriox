...
router.post('/single', auth, checkFeatureAccess('email_validation'), async (req, res) => {
  try {
...
router.post('/bulk', auth, checkFeatureAccess('email_validation'), upload.single('file'), async (req, res) => {
  let filePath = null;
